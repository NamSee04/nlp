...
def preprocess_dataset(direction='en-vi', min_freq=2, cache_dir='cache'):
    ...
    data_cache_file = os.path.join(cache_dir, f'{src_lang}_{tgt_lang}_data.pkl')
    ...
    # Set download mode and cache directory for Kaggle compatibility
    try:
        # Try to load dataset with explicit caching parameters for Kaggle
        ...
        print("Using default dataset loading method...")
