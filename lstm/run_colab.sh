...
# Set Hugging Face cache to a local directory (not on Google Drive)
...
python preprocess.py --direction en-vi --cache_dir /tmp/translation_cache

echo "Preprocessing Vietnamese to English dataset..."
python preprocess.py --direction vi-en --cache_dir /tmp/translation_cache
